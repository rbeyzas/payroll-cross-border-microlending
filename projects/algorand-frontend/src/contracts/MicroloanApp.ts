...
export type MicroloanAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<MicroloanAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<MicroloanAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<MicroloanAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**

...
export type FileSharingAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<FileSharingAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<FileSharingAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<FileSharingAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
